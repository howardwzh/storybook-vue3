<template>
  <div class="form-pro-wrapper" :style="`--items-gap:${itemsGap}`">
    <el-form ref="ruleFormRef" :label-width="labelWidth" :model="formData" :rules="rules" status-icon>
      <el-form-item
      ...
      >
        <div class="item-input-wrapper">
          ...
          <slot v-else-if="item.slot" :name="item.slot" :data="formData" />
